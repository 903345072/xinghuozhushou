...
class beijingkaijiang extends StatefulWidget {
  @override
...
class Login_ extends State<beijingkaijiang> {
  String old_pwd;
  String new_pwd;
  String re_pwd;
  bool check = false;
  ...
  void initState() {
   ...
   getFootBall() async {
     ResultData res = await HttpManager.getInstance().get("getbeijingOpenGame",withLoading: false);
    ...
    return FlutterEasyLoading(
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text("北京单场开奖详情",style: TextStyle(fontSize: ScreenUtil().setSp(18)),),
        ),
