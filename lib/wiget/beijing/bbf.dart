...
class bbf extends StatefulWidget {
  Function callBack;
  Map games;
  String e2;
  int e;
...
class _ChildState extends State<bbf> {
  @override
  void initState() {
    super.initState();
  }
...
getScore(){
  ...
  getText_(){
    String str = "";
    List list = widget.games[widget.e2][widget.e]["check_info"][5]["bet_way"];
    ...
    return widget.crs_win.asMap().keys.map((e) {
      ...
      return GestureDetector(
        onTap: (){
          ...
          String mid = widget.games[widget.e2][widget.e]["check_info"][5]["id"].toString();
          String id = widget.games[widget.e2][widget.e]["check_info"][5]["bet_way"][e]["id"].toString();
          if(checks[mid] != null){
            List attr = checks[mid];
            if(widget.games[widget.e2][widget.e]["check_info"][5]["bet_way"][e]["color"] == "co"){
          ...
          state(() {
            widget.games[widget.e2][widget.e]["check_info"][5]["bet_way"][e]
            ["color"] = widget.games[widget.e2][widget.e]["check_info"][5]
            ["bet_way"][e]["color"] ==
                "co"
                ? "red"
                : "co";
