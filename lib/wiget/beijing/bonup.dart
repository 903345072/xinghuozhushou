...
class bonup extends StatefulWidget {
  Function callBack;
  Map games;
  String e2;
  int e;
...
class _ChildState extends State<bonup> {
  @override
  void initState() {
    super.initState();
  }
          ...
          child: Row(
            ...
            children: <Widget>[
              Container(
                ...
                child: Text(total_[e] ,style: TextStyle(color: widget.games[widget.e2][widget.e]["check_info"][4]
                ["bet_way"][e]["color"] ==
                    "co"
                    ? Colors.red
