...
class bqc extends StatefulWidget {
  Function callBack;
  Map games;
  String e2;
  int e;
...
class _ChildState extends State<bqc> {
  @override
  void initState() {
    super.initState();
  }
...
getScore(){
  ...
  getText_(){
    String str = "";
    List list = widget.games[widget.e2][widget.e]["check_info"][3]["bet_way"];
